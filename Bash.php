 ...
 * @license   	https://github.com/vyctory/venus-bash/blob/master/LICENSE.md Tout droit réservé à PAQUET Judicaël
 * @version   	Release: 1.0.0
 * @filesource	https://github.com/vyctory/venus-bash
...
class Bash
{
     ...
     * @var    array
     */
    public static $backgroundCodes = array(
        'default' => 49,
        'black' => 40,
        'red' => 41,
        'green' => 42,
    ...
    {
        return self::_applyCode($sContent, self::$backgroundCodes[$sStyleName]);
    }
    ...
    {
        if (!isset(self::$backgroundCodes[$sColorName])) { $sColorName = 'black'; }

        return self::_applyCode($sContent, self::$backgroundCodes[$sColorName]);
    }
    ...
    {
        if (!isset(self::$backgroundCodes[$sColorName])) { $sColorName = 'white'; }
